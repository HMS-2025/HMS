...
def generate_html_report(yaml_path, html_path, niveau):
    ...
    <body>
        ...
        <div class="report-header">
            <h1>Hardening Magic Script - "ANSSI" Compliance Report</h1>
...
def generate_ssh_html_report(yaml_path, html_path):
    ...
    <head>
        <meta charset="UTF-8">
        <title>Hardening Magic Script - ANSSI Compliance Report (Level SSH)</title>
        <style>
            /* Main Styling */
            body {{
                font-family: Arial, sans-serif;
    ...
    <body>
        ...
        <div class="analysis-level">
            Analysis Level: <span style="font-weight: bold;">SSH</span>
        </div>
        <p class="report-date">Report Date: {datetime.now().strftime("%Y-%m-%d %H:%M:%S")}</p>
