...
class Application_ssh_test (unittest.TestCase):
    ...
    def run_tests (self):
        ...
        suite.addTest(Application_ssh_test(self.client, "test_pubkey_authentication"))
        """suite.addTest(Application_ssh_test(self.client, "test_password_authentication"))
        suite.addTest(Application_ssh_test(self.client, "test_challenge_response_authentication"))
        suite.addTest(Application_ssh_test(self.client, "test_permit_root_login"))
        suite.addTest(Application_ssh_test(self.client, "test_x11_forwarding"))
        suite.addTest(Application_ssh_test(self.client, "test_allow_tcp_forwarding"))
        suite.addTest(Application_ssh_test(self.client, "test_max_auth_tries"))

        suite.addTest(Application_ssh_test(self.client, "test_no_config_file"))
        suite.addTest(Application_ssh_test(self.client, "test_error_config_file"))
        suite.addTest(Application_ssh_test(self.client, "test_permit_empty_passwords"))
        suite.addTest(Application_ssh_test(self.client, "test_login_grace_time"))
        suite.addTest(Application_ssh_test(self.client, "test_use_privilege_separation"))
        suite.addTest(Application_ssh_test(self.client, "test_allow_users"))
        suite.addTest(Application_ssh_test(self.client, "test_allow_groups"))
        suite.addTest(Application_ssh_test(self.client, "test_ciphers"))

        suite.addTest(Application_ssh_test(self.client, "test_macs"))
        suite.addTest(Application_ssh_test(self.client, "test_permit_user_environment"))
        suite.addTest(Application_ssh_test(self.client, "test_allow_agent_forwarding"))
        suite.addTest(Application_ssh_test(self.client, "test_strict_modes"))
        suite.addTest(Application_ssh_test(self.client, "test_host_key"))
        suite.addTest(Application_ssh_test(self.client, "test_kex_algorithms"))"""
