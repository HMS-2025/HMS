...
def application_recommandations_min(path_report, client):
    ...
    apply_recommandation_acces_min(f"{path_report}/gestion_acces_minimal.yaml", client)
    apply_recommandation_maintenance_min(f"{path_report}/maintenance_minimal.yaml", client)
    apply_recommandation_mise_a_jour_min(f"{path_report}/mise_a_jour_minimal.yaml", client)
    apply_recommandation_politique_mot_de_passe_min(f"{path_report}/politique_mdp_minimal.yaml", client)
    apply_recommandation_reseau_min(f"{path_report}/reseau_minimal.yaml", client)
    apply_recommandation_service_min(f"{path_report}/services_minimal.yaml", client)
